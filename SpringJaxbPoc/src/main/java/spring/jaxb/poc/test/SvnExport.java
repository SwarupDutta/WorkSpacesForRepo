...
public class SvnExport {
	...
	public static void main(String [] args){
		...
		final String svnurl = "svn://cavcops01.global.local/skunkworks/trunk/xyz";

		final String destPath = "c:/muthu/svnfiles";

		final String svnUserName = "hulo";

		final String svnPassword = "333#";
